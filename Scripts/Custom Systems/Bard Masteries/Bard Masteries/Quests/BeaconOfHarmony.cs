...
namespace Server.Engines.Quests
{
    public class BeaconOfHarmony : BaseQuest
    {
            ...
            : base()
        {
            ...
            this.AddObjective(new CalmObjective(mongbats, 5, "mongobats"));

            this.AddReward(new BaseReward(typeof(BookOfBardMasteries), 1115679)); // Recognition for mastery of spirit soothing.
        }
        ...
        public override bool CanOffer()
        {
			...
			{
				pm.SendLocalizedMessage(1115703);
                return false;
			}
            else
			{
