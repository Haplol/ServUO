...
{
	[CorpseName( "a Anchisaur corpse" )]
	public class Anchisaur : BaseCreature
	{
		[Constructable]
		public Anchisaur () : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Anchisaur";
			Body = 1292;
			BaseSoundID = 362;
        ...
        public override void OnDeath(Container c)
        {
            ...
            if (0.20 > Utility.RandomDouble())
            {
                switch (Utility.Random(8))
                {
                    ...
                    case 1: c.DropItem(new PVPHalf()); break;
                    case 2: c.DropItem(new TamersHalf()); break;
                }
            }
        }
		...
		public Anchisaur( Serial serial ) : base( serial )
		{
		}
