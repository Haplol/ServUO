...
namespace Server.Mobiles
{
	...
	{
		[Constructable]
		public Archaeosaurus () : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Archaeosaurus";
			Body = 1287;
			BaseSoundID = 362;
			Hue = 0;
        ...
        public override void OnDeath(Container c)
        {
            ...
            if (0.20 > Utility.RandomDouble())
            {
                switch (Utility.Random(8))
                {
                    ...
                    case 1: c.DropItem(new LuckyHalf()); break;
                    case 2: c.DropItem(new MageHalf()); break;
                }
            }
        }
		...
		public Archaeosaurus( Serial serial ) : base( serial )
		{
		}
