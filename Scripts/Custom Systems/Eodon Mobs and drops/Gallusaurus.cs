...
namespace Server.Mobiles
{
	...
	{
		[Constructable]
		public Gallusaurus () : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Gallusaurus";
			Body = 1286;
			BaseSoundID = 362;
        ...
        public override void OnDeath(Container c)
        {
            ...
            if (0.20 > Utility.RandomDouble())
            {
                switch (Utility.Random(8))
                {
                    ...
                    case 1: c.DropItem(new FightersHalf()); break;
                    case 2: c.DropItem(new GroveHalf()); break;
                }
            }
        }
		...
		public Gallusaurus( Serial serial ) : base( serial )
		{
		}
