			...
			if ( info.ButtonID == 2 )
			{
				...
				else if ( Utility.Random( chance ) < 1500 )
				{
					if ( cm1 != null ) //Generate Claim Ticket One
					{
						...
						breeder.SayTo( cm1, "Return here in two hours and the show me that claim ticket i gave to you." );
					...
					if ( cm2 != null ) //Generate Claim Ticket One
					{
						...
						breeder.SayTo( cm2, "Return here in two hours and the show me that claim ticket i gave to you." );
					...
					{
						bc1.MatingDelay = DateTime.UtcNow + TimeSpan.FromHours( 2.0 );
						bc2.MatingDelay = DateTime.UtcNow + TimeSpan.FromHours( 2.0 );
					}
				}
				else
				{
					...
					{
						cm1.SendMessage( "Breeding Failed: It is hard to successfully mate to strong pets together, You will have to wait one hour to try again." );
						cm2.SendMessage( "Breeding Failed: It is hard to successfully mate to strong pets together, You will have to wait one hour to try again." );
