...
namespace daat99
{
	public class OWLTROptionsManager
	{
		...
		public void InitOwltrOptions()
		{
			...
			AddOption(OPTIONS_ENUM.DAAT99_LUMBERJACKING, new OWLTROption("Daat99 Lumberjacking", "Enabling Daat99 Lumberjacking will Make the players lumberjack random woods (acording to their skills) everywhere. Disabling it will use the standard OSI vein lumberjacking system (they could camp petrified vein 24/7).", false));
