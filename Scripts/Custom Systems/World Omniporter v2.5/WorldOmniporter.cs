...
namespace Server.Items
{
	...
	public class WorldOmniporter : Item
	{
		...
		public static void Initialize()
		{
			...
			{
				new OmniEntry("Town Center", new Point3D(1043, 530, -90), Map.Malas ),
				new OmniEntry("Heartwood", new Point3D(7025, 382, 0), Map.Trammel ),
				new OmniEntry("Hue Room", new Point3D(5379, 1094, 0), Map.Trammel ),
				new OmniEntry("Gate Room", new Point3D(6079, 451, -22), Map.Felucca ),
				new OmniEntry("Crafter Spawn", new Point3D(5979, 2984, 14), Map.Felucca ),
			});
	...
	public class WorldOmniporterGump : Gump
	{
		...
		
		{
			...
			AddHtml(165, 12, 200, 15, "<basefont color=#FFFFFF>World Teleporter</basefont>", false, false ); 
