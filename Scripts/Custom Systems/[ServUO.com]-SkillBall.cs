...
namespace Server
{
                ...
                case 1:
                    {
                        ...
                        {
                            m.SendGump(new SkilllimPickGump(m_SkillBall));
                            m.SendMessage(0, "Please get rid of {0} skills, you have exceeded the 5 skill that are allowed.", info.Switches.Length - switches);
                            break;
    ...
    public class SkillBall : Item
    {
        ...
        public override void OnDoubleClick(Mobile m)
        {
            ...
            {
                m.SendMessage("Please choose your 5 skill to set to GM.");
