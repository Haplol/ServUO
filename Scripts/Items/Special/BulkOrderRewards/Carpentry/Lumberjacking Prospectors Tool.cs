...
namespace Server.Items
{
	public class LumberjackingProspectorsTool : BaseAxe
	{
		...
		public void Prospect( Mobile from, object toProspect )
		{
            ...
            {
                from.SendLocalizedMessage(1049049); // That Tree looks to be prospected already.
                return;
            }
			...
			if ( veinIndex < 0 )
			{
				...
				{
					from.SendMessage( "You cannot improve petrified wood through prospecting." );
				}
				else
				{
					...
					switch ( veinIndex )
					{
						...
						case 3: from.SendMessage( "You sift through the tree and find heart wood can be lumberjacked there" ); break;//Yew
						case 4: from.SendMessage( "You sift through the tree and find blood wood can be lumberjacked there" ); break;//Oak
						case 5: from.SendMessage( "You sift through the tree and find frost wood can be lumberjacked there" ); break;//Zircote
						case 6: from.SendMessage( "You sift through the tree and find Ebony wood can be lumberjacked there" ); break;//Oak
						case 7: from.SendMessage( "You sift through the tree and find Bamboo wood can be lumberjacked there" ); break;//Oak
						case 8: from.SendMessage( "You sift through the tree and find PurpleHeart wood can be lumberjacked there" ); break;//Oak
						case 9: from.SendMessage( "You sift through the tree and find Redwood can be lumberjacked there" ); break;
						case 10: from.SendMessage( "You sift through the tree and find petrified wood can be lumberjacked there" ); break;
					}
