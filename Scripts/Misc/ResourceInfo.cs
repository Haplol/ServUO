    ...
    public class CraftResources
    {
        ...
        private static readonly CraftResourceInfo[] m_WoodInfo = new CraftResourceInfo[]
        {
            //daat99 OWLTR start - custom wood
				...
				new CraftResourceInfo( 1156, 0,			"Bamboo",		CraftAttributeInfo.Bamboo,		CraftResource.Bamboo,		typeof(BambooBoard),		typeof( BambooLog ) ),
				...
				new CraftResourceInfo( 2726,   0,		"Redwood",		CraftAttributeInfo.Redwood,		CraftResource.Redwood,		typeof(RedwoodBoard),		typeof( RedwoodLog ) ),
        ...
        public static CraftResource GetFromOreInfo(OreInfo info)
        {
            ...
            //daat99 OWLTR start - custom wood
             ...
             if (info.Name.IndexOf("Wood") >= 0 && info.Level >= 0 && info.Level <= 11) //changed from 11
               return (CraftResource)(info.Level + 301);
            //daat99 OWLTR end - custom wood
            return CraftResource.None;
        }
        /// <summary>
