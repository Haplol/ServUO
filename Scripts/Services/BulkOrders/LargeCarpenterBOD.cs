...
namespace Server.Engines.BulkOrders
{
	...
	public class LargeCarpenterBOD : LargeBOD
	{
		...
		public LargeCarpenterBOD()
		{
			...
			{
				default:
				case  0: entries = LargeBulkEntry.ConvertEntries( this, LargeBulkEntry.LargeWeapon );  break;
                case  1: entries = LargeBulkEntry.ConvertEntries(this, LargeBulkEntry.LargeArmor); break;
                case  2: entries = LargeBulkEntry.ConvertEntries(this, LargeBulkEntry.LargeInstrument); break;
