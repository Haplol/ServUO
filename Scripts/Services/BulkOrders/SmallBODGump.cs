    ...
    public class SmallBODGump : Gump
    {
            ...
            : base(25, 25)
        {
            ...
            if (deed.Material != BulkMaterialType.None)
                ...
                AddHtml(75, deed.RequireExceptional ? 168 : 144, 400, 25, "<basefont color=#FF0000>All items must be crafted with " + GetMaterialStringFor(deed.Material), false, false);
        ...
        public static string GetMaterialStringFor(BulkMaterialType material)
        {
            ...
            switch ((int)material)
            {
                ...
                case 24: result = "oak"; break;
                case 25: result = "ash"; break;
                case 26: result = "yew"; break;
                case 27: result = "heartwood"; break;
                case 28: result = "bloodwood"; break;
                case 29: result = "frostwood"; break;
                case 30: result = "ebony"; break;
                case 31: result = "bamboo"; break;
                case 32: result = "purpleheart"; break;
                case 33: result = "redwood"; break;
                case 34: result = "petrified"; break;
            }
            return result;
        }
