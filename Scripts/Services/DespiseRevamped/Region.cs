	...
	public class DespiseRegion : BaseRegion
	{
        ...
        public bool CheckTravel(Mobile from, TravelCheckType type)
        {
            ...
            switch (type)
            {
                ...
                case TravelCheckType.RecallTo: return true;
                case TravelCheckType.GateFrom: return true;
                case TravelCheckType.GateTo: return true;
                case TravelCheckType.Mark: return true;
