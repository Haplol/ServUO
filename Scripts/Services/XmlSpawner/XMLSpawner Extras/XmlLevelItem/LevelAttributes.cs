...
namespace Server.Items
{
	...
	public class LevelAttributes
	{
		...
		{
			new AttributeInfo( AosAttribute.RegenHits, "Regen Hits", AttributeCategory.Stats, 5, 8 ),
			new AttributeInfo( AosAttribute.RegenStam, "Regen Stamina", AttributeCategory.Stats, 5, 8 ),
			new AttributeInfo( AosAttribute.RegenMana, "Regen Mana", AttributeCategory.Stats, 5, 8 ),
			...
			new AttributeInfo( AosAttribute.BonusHits, "Bonus Hits", AttributeCategory.Stats, 5, 10 ),
			new AttributeInfo( AosAttribute.BonusStam, "Bonus Stamina", AttributeCategory.Stats, 5, 10 ),
			new AttributeInfo( AosAttribute.BonusMana, "Bonus Mana", AttributeCategory.Stats, 5, 10 ),
			new AttributeInfo( AosAttribute.WeaponDamage, "Damage Increase", AttributeCategory.Melee, 5, 80 ),
			new AttributeInfo( AosAttribute.WeaponSpeed, "Swing Speed Increase", AttributeCategory.Melee, 6, 40 ),
			new AttributeInfo( AosAttribute.SpellDamage, "Spell Damage", AttributeCategory.Magic, 4, 50 ),
			...
			new AttributeInfo( AosAttribute.LowerManaCost, "Lower Mana Cost", AttributeCategory.Magic, 5, 20 ),
			new AttributeInfo( AosAttribute.LowerRegCost, "Lower Reagent Cost", AttributeCategory.Magic, 5, 30 ),
			...
			new AttributeInfo( AosAttribute.Luck, "Luck", AttributeCategory.Misc, 2, 200 ),
		...
		public static WeaponAttributeInfo[] m_WeaponAttributes = new WeaponAttributeInfo[]
		{
			...
			new WeaponAttributeInfo( AosWeaponAttribute.HitLeechHits, "Hit Life Leech", AttributeCategory.Hits, 3, 80 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitLeechStam, "Hit Stamina Leech", AttributeCategory.Hits, 3, 80 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitLeechMana, "Hit Mana Leech", AttributeCategory.Hits, 3, 80 ),
			...
			new WeaponAttributeInfo( AosWeaponAttribute.HitMagicArrow, "Hit Magic Arrow", AttributeCategory.Hits, 3, 70 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitHarm, "Hit Harm", AttributeCategory.Hits, 3, 70 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitFireball, "Hit Fireball", AttributeCategory.Hits, 3, 70 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitLightning, "Hit Lightning", AttributeCategory.Hits, 3, 70 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitDispel, "Hit Dispel", AttributeCategory.Hits, 3, 70 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitColdArea, "Hit Cold Area", AttributeCategory.Hits, 3, 70 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitFireArea, "Hit Fire Area", AttributeCategory.Hits, 3, 70 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitPoisonArea, "Hit Poison Area", AttributeCategory.Hits, 3, 70 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitEnergyArea, "Hit Energy Area", AttributeCategory.Hits, 3, 70 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitPhysicalArea, "Hit Physical Area", AttributeCategory.Hits, 3, 70 ),
